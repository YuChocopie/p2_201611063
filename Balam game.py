...
while True:
	...
	print add 
	circle((-200,100),50,"black")
    if isInCircle(pos1,10,pos2) and isInCircle((-200,100),10,pos3) and 8<add:
        circle((-100,100),50,"green")
	add=add+1 
	print add 
    if isInCircle(pos1,10,pos2) and isInCircle((-100,100),10,pos3) and 8<add:
	add=add+1 
	print add 
	circle((0,100),50,"cyan")    
    if isInCircle(pos1,10,pos2) and isInCircle((0,100),10,pos3) and 9<add:
	add=add+1 
	print add 
        circle((100,100),50,"violet")
